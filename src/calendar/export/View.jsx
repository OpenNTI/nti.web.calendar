...
const t = scoped('nti-calendar.export', {
	...
	message: 'Export your calendars and add them to your favorite app. They will stay in sync as new events are added.',
	...
	render () {
		...
		return (
			<div className="nti-calendar-export">
				...
				{!loading && error && (<EmptyState subHeader={t('unavailable')} />)}
				{!loading && !error && (
